...
public abstract class CrossIterator<S, D extends TracableStep<S>> implements Iterator<S> {
  ...
  public boolean hasNext() {
    ...
    if (!isConnectedComponentExhausted()) {
      ...
      // @TODO strategy for fr.mx.pathfinding.data_structure.graph with multiple components.
      return false;
    }
  }
  ...
  /**
   * For fr.mx.pathfinding.data_structure.graph data structure, could have multiple components (see "linked fr.mx.pathfinding.data_structure.graph).
   *
