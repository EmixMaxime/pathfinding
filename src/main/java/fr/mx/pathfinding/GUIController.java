...
//
//          var fr.mx.pathfinding.data_structure.map = mapSearch.getMap();
//          var s = fr.mx.pathfinding.data_structure.map.getElement(start);
//          var g = fr.mx.pathfinding.data_structure.map.getElement(end);
//
//          var it = new BreadthFirstIterator<>(fr.mx.pathfinding.data_structure.map, s, g);
//          while (it.hasNext()) {
...
//        }
        ...
        protected MapSearch call() {
          System.out.println("call in thread for fr.mx.pathfinding.data_structure.map " + mapName);
...
//          return mapSearch;
  ...
  private void runPathFinding(MouseEvent mouseEvent) {
    ...
    System.out.println("run new thread for fr.mx.pathfinding.data_structure.map " + mapName);
